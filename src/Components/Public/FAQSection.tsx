...
const faqItems: FAQItem[] = [
  {
    ...
    answer:
      "Search your destination, choose your preferred property, review availability and details, then complete your reservation through our secure booking flow. Once confirmed, you will receive all stay information and host contact details.",
  },
  {
    id: 2,
    ...
    answer:
      "Yes. AuraSpace is designed around trusted and curated experiences. Listings are reviewed for quality, accuracy, amenities, photos, pricing transparency, and guest suitability before being highlighted on the platform.",
  },
  {
    id: 3,
    category: "Payments",
    ...
    answer:
      "Absolutely. AuraSpace supports a secure checkout experience with modern payment standards. Your payment details are processed safely, and booking information is handled with privacy and reliability in mind.",
  },
  {
    id: 4,
    ...
    answer:
      "Cancellation and modification options depend on the property’s policy. You can review the cancellation terms before booking, and your reservation details will show the available options after confirmation.",
  },
  {
    id: 5,
    category: "Events",
    ...
    answer:
      "Yes. AuraSpace supports premium event venues including rooftops, garden estates, luxury halls, private villas, and corporate spaces. You can browse event-friendly listings and request details based on your occasion.",
  },
  {
    id: 6,
    category: "Hosting",
    ...
    answer:
      "Hosts can list their property by submitting property details, images, location, amenities, pricing, and availability. After review, approved listings can start receiving booking requests from premium guests.",
  },
];
...
export default function FAQSection() {
  ...
  return (
    ...
    >
      ...
      <div className="relative mx-auto w-full container px-4 sm:px-6 lg:px-8">
        <motion.div
          initial="hidden"
        ...
        >
          ...
          >
            Clear answers about booking premium stays, verified listings, secure
            payments, hosting, guest support, and event-ready venues.
          </motion.p>
          ...
          >
            <div className="p-5 sm:p-6">
              ...
              <p className="mt-3 text-sm leading-[1.8] text-slate-500">
                AuraSpace keeps premium booking simple, transparent, and
                reliable for guests, hosts, and event organizers.
              </p>
