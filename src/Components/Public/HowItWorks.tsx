    ...
    >
      ...
      <div className="relative mx-auto w-full container px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            From discovery to checkout, AuraSpace makes booking premium
            properties and event venues effortless, secure, and refined.
          </motion.p>
          ...
          >
            ...
            <motion.div
              ...
              animate={reduceMotion ? undefined : { rotate: [45, 225, 405] }}
              transition={{
                duration: 8,
                repeat: Infinity,
                ease: "linear",
            ...
            <div className="relative z-10 flex flex-col items-center gap-5 p-7 text-center sm:flex-row sm:gap-6 sm:p-8 sm:text-left">
              ...
              <div className="flex-1">
                ...
                <p className="mt-2 text-sm leading-relaxed text-white/60">
                  Start browsing curated properties or list your own space and
                  join the AuraSpace community.
                </p>
              </div>
