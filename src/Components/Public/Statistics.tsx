...
const statsData: StatItem[] = [
  {
    ...
    description: "Verified luxury hotels, resorts, and exclusive event halls.",
    icon: (
      <svg
        className="h-6 w-6"
        fill="none"
  ...
  },
  {
    ...
    value: "450K+",
    label: "Happy Guests",
    description: "Memorable experiences delivered worldwide with elevated comfort.",
    icon: (
      <svg
        className="h-6 w-6"
        fill="none"
  ...
  },
  {
    ...
    description: "Professional hosts managing premium spaces with custom decor support.",
    icon: (
      <svg
        className="h-6 w-6"
        fill="none"
  ...
  },
  {
    ...
    description: "Flawless execution of birthdays, anniversaries, and corporate events.",
    icon: (
      <svg
        className="h-6 w-6"
        fill="none"
    ...
    <section className="relative w-full overflow-hidden bg-white py-16 text-slate-950 sm:py-20 lg:py-24">
      ...
      <div className="relative z-10 mx-auto w-full container px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            From luxury suite bookings to curated event experiences, AuraSpace
            continues to earn trust through premium spaces, seamless hosting,
