...
function useTiltEffect() {
  ...
  return { rotateX, rotateY, handleMouse, handleMouseLeave, springX, springY };
}
  ...
  return (
    ...
    >
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        ...
        <motion.div
          ...
          animate={
            reduceMotion
              ? {}
              : {
                  scale: [1.05, 0.85, 1.15, 0.95, 1.05],
                  x: [0, -40, 20, -10, 0],
                  y: [0, -30, 35, -15, 0],
                  rotate: [0, -15, 10, -8, 0],
                }
        ...
        />
        <motion.div
          className="absolute left-1/2 top-1/4 h-40 w-40 rounded-full bg-sky-50/40 blur-3xl sm:h-56 sm:w-56"
          animate={
            reduceMotion
              ? {}
              : {
      ...
      <div className="relative z-10 mx-auto w-full container px-4 sm:px-6 lg:px-8">
            ...
            <div className="max-w-2xl">
              ...
              >
                ...
                <span className="relative inline-block">
                  <motion.span
                    className="relative z-10 bg-gradient-to-r from-indigo-600 via-violet-600 to-indigo-500 bg-clip-text text-transparent"
                    animate={
                      reduceMotion
                        ? {}
                        : {
                  ...
                  <motion.span
                    ...
                    animate={
                      isInView ? { scaleX: [0, 1, 0], opacity: [0, 0.5, 0] } : {}
                    }
                    transition={{
                      duration: 1.2,
                      delay: 0.8,
                    ...
                    className="absolute -bottom-1 left-0 h-[3px] w-full origin-left rounded-full bg-gradient-to-r from-indigo-300 via-violet-300 to-indigo-200 blur-sm"
                  />
                </span>
              </motion.h2>
              ...
              >
                AuraSpace brings together premium properties, smart booking
                technology, and world-class support — creating a seamless
                experience for travelers, hosts, and event organizers alike.
              </motion.p>
            </div>
        ...
        <motion.div
          ...
          animate={isInView ? "visible" : "hidden"}
          variants={containerVariants}
          className="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:gap-5 lg:auto-rows-[minmax(210px,auto)] lg:grid-cols-3 lg:gap-5 xl:auto-rows-[minmax(230px,auto)] xl:gap-6"
        >
        ...
        >
          ...
          >
            <motion.span
              className="absolute inset-0 bg-gradient-to-r from-indigo-600 to-violet-600 opacity-0 transition-opacity duration-300 group-hover:opacity-100"
            />
...
function LargeCard({
  ...
  const { rotateX, rotateY, handleMouse, handleMouseLeave, springX, springY } =
    useTiltEffect();
  ...
  return (
    ...
    >
      ...
      <motion.div
        className="pointer-events-none absolute inset-x-0 top-0 z-10 h-[3px] origin-left bg-gradient-to-r from-indigo-500 via-violet-500 to-fuchsia-500"
        initial={{ scaleX: 0 }}
        whileInView={{ scaleX: 0 }}
        style={reduceMotion ? {} : { transformOrigin: "left" }}
      >
        <motion.div
          className="absolute inset-0 bg-gradient-to-r from-indigo-500 via-violet-500 to-fuchsia-500"
          initial={{ scaleX: 0 }}
          animate={{ scaleX: 0 }}
          whileHover={{ scaleX: 1 }}
        />
      ...
      <div className="relative z-10 flex h-full flex-col p-6 sm:p-8 lg:p-9">
        <div className="mb-5 flex flex-wrap items-center gap-3 sm:mb-6">
          <motion.div
            ...
            style={reduceMotion ? {} : { transformStyle: "preserve-3d" as const, translateZ: 40 }}
          >
            {service.icon}
          </motion.div>
              ...
              animate={
                reduceMotion
                  ...
                  : {
                      ...
                      boxShadow: [
                        "0 0 0 0 rgba(99,102,241,0)",
                        "0 0 8px 3px rgba(99,102,241,0.5)",
                        "0 0 0 0 rgba(99,102,241,0)",
                      ],
                    }
              }
        ...
        <motion.h3
          ...
          style={reduceMotion ? {} : { transformStyle: "preserve-3d" as const, translateZ: 30 }}
        >
          {service.title}
        </motion.h3>
        ...
        <motion.p
          ...
          style={reduceMotion ? {} : { transformStyle: "preserve-3d" as const, translateZ: 20 }}
        >
          {service.description}
        </motion.p>
        ...
        <motion.div
          ...
          style={reduceMotion ? {} : { transformStyle: "preserve-3d" as const, translateZ: 25 }}
        >
      ...
      <motion.div
        className="pointer-events-none absolute -right-12 -bottom-12 z-0 h-44 w-44 rounded-full border border-indigo-100/60"
        animate={
          reduceMotion
            ? {}
            : {
      ...
      />
      <motion.div
        className="pointer-events-none absolute -right-7 -bottom-7 z-0 h-32 w-32 rounded-full border border-indigo-100/80"
        animate={
          reduceMotion
            ? {}
            : {
    ...
    >
      {service.image && (
        <div className="absolute inset-0 z-0 overflow-hidden">
          ...
          <motion.div
            className="absolute inset-0 bg-gradient-to-br from-indigo-600/25 via-transparent to-violet-600/20 opacity-0 transition-opacity duration-700"
...
function TextCard({
  ...
  return (
    <motion.div
      ...
      className="relative flex h-full min-h-[200px] w-full flex-col overflow-hidden rounded-2xl border border-slate-200/80 bg-white p-5 transition-all duration-500 group-hover:border-indigo-200 group-hover:shadow-2xl group-hover:shadow-indigo-500/10 sm:min-h-[220px] sm:rounded-3xl sm:p-6 lg:min-h-0 lg:p-7"
    >
      ...
      <div className="relative z-10 flex h-full flex-col">
        <motion.div
          ...
          transition={{ type: "spring", stiffness: 400, damping: 12 }}
          style={reduceMotion ? {} : { transformStyle: "preserve-3d" as const, translateZ: 35 }}
        >
          {service.icon}
        </motion.div>
        ...
        <motion.p
          ...
          style={reduceMotion ? {} : { transformStyle: "preserve-3d" as const, translateZ: 15 }}
        >
          {service.description}
        </motion.p>
