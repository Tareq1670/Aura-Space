        ...
        <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-indigo-50/40">
            <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12">
                    ...
                    <div className="px-4 sm:px-8 pb-6 sm:pb-8 -mt-16 sm:-mt-20 relative">
                        <div className="flex flex-col sm:flex-row sm:items-end gap-3 sm:gap-4 mb-4">
                            ...
                            <div className="relative shrink-0">
                                <Skeleton className="w-24 h-24 sm:w-32 sm:h-32 rounded-3xl border-4 border-white shadow-2xl" />
                                {/* Camera button placeholder */}
                                <Skeleton className="absolute -bottom-1 -right-1 w-10 h-10 rounded-2xl" />
                            </div>
                        </div>
                ...
                <div className="bg-white rounded-3xl shadow-lg shadow-indigo-950/5 border border-slate-200/60 p-5 sm:p-8 mb-6">
                    ...
                    <div className="flex items-center justify-between mb-6 flex-wrap gap-2">
                        <div className="flex items-center gap-3">
                            <Skeleton className="w-10 h-10 sm:w-11 sm:h-11 rounded-2xl" />
                    ...
                    <div className="grid sm:grid-cols-2 gap-3 sm:gap-4">
                        {Array.from({ length: 4 }).map((_, i) => (
                            <div
                                key={i}
                                className="p-4 rounded-2xl bg-gradient-to-br from-slate-50 to-slate-50/50 border-2 border-slate-100 space-y-2"
                            >
                ...
                <div className="bg-white rounded-3xl shadow-lg shadow-indigo-950/5 border border-slate-200/60 p-5 sm:p-8 mb-6">
                    ...
                    {/* Password status box */}
                    <div className="flex items-center gap-3 p-4 rounded-2xl bg-gradient-to-br from-emerald-50 to-teal-50/50 border-2 border-emerald-100">
...
export default function ProfilePage() {
    ...
    const handleSaveProfile = async () => {
        ...
        if (trimmed.length < 3)
            return void toast.error("Name needs 3+ characters.");
    ...
    const handleChangePassword = async () => {
        if (!currentPassword)
            return void toast.error("Current password required.");
                    ...
                    <div className="p-4 sm:p-5 rounded-2xl bg-gradient-to-br from-rose-50 to-red-50/50 border-2 border-rose-100 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                        <div>
                            ...
                            <p className="text-xs text-slate-500 mt-0.5">
                                All data, bookings and history will be removed
                                forever.
                            </p>
                        </div>
