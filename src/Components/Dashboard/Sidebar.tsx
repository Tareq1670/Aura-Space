...
const roleConfig: Record<RoleKey, { label: string; gradient: string }> = {
    ...
    host: { label: "Host", gradient: "from-indigo-500 to-violet-500" },
    admin: { label: "Admin", gradient: "from-violet-500 to-pink-500" },
};
...
const SidebarInner = ({
    ...
    return (
        <div className="relative h-full flex flex-col bg-brand-dark overflow-hidden">
            ...
            <div className="absolute top-1/3 -left-10 w-32 h-32 rounded-full bg-violet-500/10 blur-3xl pointer-events-none" />
                    ...
                    >
                        ...
                        >
                            <div className="relative flex-shrink-0">
                                ...
                                <div className="relative w-10 h-10 rounded-xl bg-gradient-to-br from-violet-500 via-indigo-500 to-violet-600 flex items-center justify-center shadow-brand overflow-hidden group-hover:scale-105 transition-transform duration-300">
