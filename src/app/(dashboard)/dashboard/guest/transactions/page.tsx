  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-violet-50/40 p-6 lg:p-8">
      ...
      >
        ...
        <StatCard icon={<CreditCard className="h-5 w-5" />} label="This Month" value={Math.round(totalSpend * 0.2 * 100) / 100} trend={{ label: "Estimated", positive: true }} gradient="from-amber-500 to-orange-500" />
      </motion.div>
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="px-5 py-3.5">
                        <span className="inline-flex items-center gap-1.5 rounded-full border border-emerald-200 bg-emerald-50 px-3 py-1 text-xs font-semibold capitalize text-emerald-700">
